...
const images={};
const ASSET_FILES={sprites:'sprites-prathek-v1.png',tiles:'tiles.png',gates:'gates-prathek-v1.png',commons:'background-commons-v3.png',factory:'background-sprinkleworks-v3.png',castle:'background-gauntlet-v3.png',story1:'story-1-happy.png',story2:'story-2.png',story3:'story-3-prathek-v1.png',story4:'story-4-v2.png',story5:'story-5-prathek-v1.png',victory:'story-6-prathek-v1.png',castLineup:'cast-lineup-prathek-v1.png',catPortrait:'portrait-cat-v1.png',prathekPortrait:'portrait-prathek-v1.png',pretzelPortrait:'portrait-pretzel-v1.png'};
...
function unlockAudio(){
  try{
    ...
    if(MUSIC_FILE&&!muted&&scene!=='ending'&&backgroundMusic.paused)backgroundMusic.play().catch(()=>{});
  }catch{}
}
...
function shoot(){if(hero.shootCd>0||hero.cream<1)return say('Out of eggs — reloading!');hero.shootCd=.28;hero.cream--;hero.creamClock=0;projectiles.push({x:hero.x+22+hero.dir*25,y:hero.y+25,w:18,h:14,vx:hero.dir*570,vy:-15,owner:'hero',life:1.6,kind:'cream'});updateHud();tone(290,.06,'triangle')}
...
function respawn(){hero.hearts=3;hero.x=checkpoint.x;hero.y=checkpoint.y;hero.vx=hero.vy=0;hero.invuln=1.2;updateHud();say('Cath returns with renewed determination.')}
...
function showEnding(){scene='ending';stopMusic();hide(ui.dialogue);hide(ui.dialogueReview);hide(ui.hud);hide(ui.controls);hide(ui.bossHud);show(ui.endingScreen);confetti(160);tone(523,.15);setTimeout(()=>tone(659,.15),160);setTimeout(()=>tone(784,.3),320)}
