# Pixel artwork prompt set

The production artwork was generated as original, low-resolution Roman-bakery pixel art. All images use chunky silhouettes, dark plum outlines, stepped highlights, a bright birthday-friendly palette, no text, and no watermark.
...
Versioned `story-3-prathek-v1.png`, `story-4-v2.png`, and `story-5-prathek-v1.png` implement the corrected prison staging, Prathek continuity, and Catherine's curly-haired design. Story panels are displayed in full with `object-fit: contain` rather than cropped.

`story-6-prathek-v1.png` is the illustrated victory panel. It shows curly-haired Catherine standing triumphant with her sling and buckler, Emperor Prathek comically defeated with his crown fallen over his eyes, and the rescued Pretzel People escorting him away from the raspberry fortress.

`cast-lineup-prathek-v1.png`, `portrait-cat-v1.png`, `portrait-prathek-v1.png`, and `portrait-pretzel-v1.png` use the supplied detailed Roman-bakery character lineup as their visual reference. The production edit preserves the five roles, gives Catherine visible dark-brown curls, removes the flat chroma-key background, and supplies the title screen, top bar, HUD, gift seal, and dialogue portraits with consistent high-detail pixel artwork.
